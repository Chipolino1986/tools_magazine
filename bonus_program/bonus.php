...
<body>
    <section class="section-1">
        ...
        <div class="container">
            <div class="title_container_box">
                ...
                <p>Получайте бонусы за покупки 
                   в "Жёлтый молоток" и расплачивайтесь 
                   ими при следующих покупках.  
                </p>
            </div>
            <div class="img_box">
    ...
    <section class="section-2">
        <div class="container_section-2">
            <h1>Всё просто - вы покупаете товары,<br>
                мы возвращаем вам часть покупки бонусами
            </h1>
            <div class="promo-box">
                <div class="item1">
                ...
                <p>
                    * Внимание, бонусные баллы сгорают, если у вас не 
                    было заказов в течение последних 6 месяцев.
                </p>
            </div>
        </div>
    </section>
