...
<head>
    ...
    <link rel="stylesheet" href="./landing-2/section-1.css">
    <link rel="stylesheet" href="./landing-2/section-2.css">
    <link rel="stylesheet" href="./burger.css">
    <link rel="stylesheet" href="./footer/style_footer.css">
    <link rel="stylesheet" href="./landing-2/media-landing.css">

    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@500&display=swap" rel="stylesheet">
    
    <script defer src="./landing-2/landing.js"></script>
        ...
        <section class="section-1">
            ...
            <div class="slider_wrapper"> 
                ...
                <div class="slider_container">    
                   ...
                   <button class="btn_next"><i class="fa-solid fa-circle-chevron-right"></i></button>
            ...
            <div class="aside_container">
                ...
                <div class="sidebar">
                    <ul>
                        ...
                        <li>100% возврат денег если товар не подошёл или вышел из строя(не по вашей вине)</li>
                    </ul>
                </div>
            </div>
        </aside>
