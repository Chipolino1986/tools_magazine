...
<head>
    ...
    <link rel="stylesheet" href="./media_contacts.css">
            ...
            <div class="container_1_content">
                ...
                <div class="info_box">
                    <div class="information_box">
                        ...
                        <p>Наш телефон: 8 (800) 000 00 00</p>
                        <p>Наш адресс: 300001, г.Тула, ул.Патронная д.27</p>
                        <p>Наш E-mail: RemClimat@yandex.ru</p>
                        <p>Как к нам добраться:(заезд со стороны ул.Каракозова!)</p>
                    </div>
                    <div class="work_time">
                        <h2>Время работы интернет-магазина:</h2>
                        <p>понедельник-четверг: с 9:00 до 18:00</p>
                        <p>пятница: с 9:00 до 17:00</p>
                        <p><span>суббота-воскресенье: выходной</span></p>
                    </div>
                    <div class="location">
                        <div id="map">
                            <script type="text/javascript" charset="utf-8" 
                            async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3A46cedc54ed9eb41f585c439b418ddcc3ffbf0f0532846c6e80383d8051ac32b8&amp;
                            width=320&amp;height=250&amp;lang=ru_RU&amp;scroll=true"></script>
                        </div>
                    </div>
                    <div class="requisites_box">
                        <h1>РЕКВИЗИТЫ ИНТЕРНЕТ-МАГАЗИНА <span>"ЖЁЛТЫЙ МОЛОТОК"</span>:</h1>
                        <P>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                            Laborum atque molestias libero dignissimos dolorem deserunt cupiditate 
                            delectus facilis iusto expedita, at nemo. Aspernatur necessitatibus 
                            cupiditate quia sapiente quaerat nam tenetur?</P>
                    </div>
                </div>
            </div>
        </div>
