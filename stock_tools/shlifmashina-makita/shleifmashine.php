...
<head>
    ...
    <title>Шлифовальная машина Makita</title>
    <link rel="stylesheet" href="../../NORMALIZE!!!/normalize.css">
    <link rel="stylesheet" href="./shleifmashine.css">
...
<body>
    ...
    <section class="section-1">
        ...
        <div class="container">
            <h1>Шлифовальная машина Makita</h1>
                <div class="img_box_wrapper">

                    <div class="img_box">
                        <img
                            class="img_huter"
                            src="../../images/img_tools_500x500/stock/shleifmashina-makita-600x600.png"
                            id="open_pop_up"
                            alt=""
                        >
                        <div class="pop_up" id="pop_up">
                            <div class="pop_up_container">
                                <div class="pop_up_body">
                                    ...
                                    <img src="../../images/img_tools_500x500/stock/shleifmashina-makita-600x600.jpg">
            ...
            <div class="description_box">
                <div class="options">
                    <ul>
                        ...
                        <li>Макс.частота колебания:</li>
                        <li>Размер хода платформы:</li>
                        <li>Макс.диаметр диска:</li>
                        <li>Крепление листа:</li>
                        <li>Питание:</li>
                    </ul>
                </div>
            ...
            <div class="dastination">
                <p>
                    Шлифмашина эксцентриковая MAKITA BO5031 используется 
                    для шлифования и полировки. Для более качественной 
                    обработки каких-либо заготовок, можно регулировать не 
                    только число оборотов, но и колебаний диска. 
                    Мощный мотор помогает справиться с тяжелыми задачами. 
                    Шлифовальная бумага, крепящаяся на липучку, делает процесс 
                    замены рабочего материла легким и быстрым.
                </p>
            </div>
