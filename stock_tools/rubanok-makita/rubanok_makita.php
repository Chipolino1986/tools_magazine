...
<head>
    ...
    <title>Электрорубанок Makita</title>
    <link rel="stylesheet" href="../../NORMALIZE!!!/normalize.css">
    <link rel="stylesheet" href="./rubanok_makita.css">
            ...
            <h1>Рубанок Makita M1902</h1>
                <div class="img_box_wrapper">
                    ...
                    <div class="img_box">
                        <img
                            class="img_huter"
                            src="../../images/img_tools_500x500/electro/electrorubanok_makita-1200x1200.png"
                            id="open_pop_up"
                            alt=""
                        >
                        <div class="pop_up" id="pop_up">
                            <div class="pop_up_container">
                                <div class="pop_up_body">
                                    ...
                                    <img src="../../images/img_tools_500x500/electro/electrorubanok_makita-1200x1200.jpeg">
            ...
            <div class="description_box">
                <div class="options">
                    <ul>
                        ...
                        <li>Тип:</li>
                        <li>мощность:</li>
                        <li>Ширина строгания:</li>
                        <li>Глубина строгания:</li>
                        <li>Число оборотов:</li>
                ...
                <div class="options_descriptions">
                    ...
                    <p>есть</p>
                    <p>от сети</p>
                    <p>возможность подключения пылесоса</p>
                </div>
            </div>
            <div class="dastination">
                <p>
                    Рубанок Makita M1902 служит для качественной 
                    обработки деревянных поверхностей. Имеет большой 
                    V-образный паз для легкого торцевания. Обрабатываемая 
                    заготовка защищена от повреждений в процессе работы. 
                    Регулятор глубины строгания совмещен с рукояткой для 
                    более удобного управления. Предусмотрена возможность 
                    подключения пылеудаляющего аппарата для поддержания 
