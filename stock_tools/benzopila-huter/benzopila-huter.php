...
<head>
    ...
    <title>Бензопила Huter</title>
    <link rel="stylesheet" href="../../NORMALIZE!!!/normalize.css">
    <link rel="stylesheet" href="./benzopila-huter.css">
            ...
            <h1>Бензопила Huter</h1>
                <div class="img_box_wrapper">
                    ...
                    <div class="img_box">
                        <img
                            class="img_huter"
                            src="../../images/img_tools_500x500/bs-40-1-800x800.png"
                            id="open_pop_up"
                            alt=""
                        >
                        <div class="pop_up" id="pop_up">
                            <div class="pop_up_container">
                                <div class="pop_up_body">
                                    ...
                                    <img src="../../images/img_tools_500x500/bs-40-1-800x800.png">
            ...
            <div class="description_box">
                <div class="options">
                    <ul>
                        ...
                        <li>тип:</li>
                        <li>мощность (л.с.):</li>
                        <li>количество звеньев цепи:</li>
                        <li>шаг цепи:</li>
                        <li>объём двигателя:</li>
                        <li>тип маслянного насоса:</li>
                        <li>автоматическая смазка цепи:</li>
                        <li>система гошения вибрации:</li>
                        <li>комплектация:</li>
                    </ul>
                </div>
                <div class="options_descriptions">
                    ...
                    <p>Да</p>
                    <p>
                        Цепь, Шина, Защитный кожух, Ёмкость для смешивания топливной смеси
                    </p>
                </div>
            </div>
            <div class="dastination">
                <p>
                    Бензопила Huter BS-40 оснащена двигателем с мощностью 2 
                    лошадиные силы, имея при этом компактный корпус. С её помощью 
                    можно подрезать деревья в саду, заниматься заготовкой дров и 
                    мелким ремонтом. Древесину можно пилить вдоль и поперек. 
                    Модель имеет двухтактный одноцилиндровый двигатель. 
                    Топливная смесь состоит из бензина и масла в соотношении 25:1. 
                    Объём топливного бака составляет 0,31 л.
                </p>
            </div>
