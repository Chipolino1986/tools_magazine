...
<head>
    ...
    <title>Газонокосилка Huter</title>
    <link rel="stylesheet" href="../../NORMALIZE!!!/normalize.css">
    <link rel="stylesheet" href="./gazon_huter.css">
            ...
            <h1>Газонокосилка Huter GLM-5.0 ST</h1>
                <div class="img_box_wrapper">
                    ...
                    <div class="img_box">
                        <img
                            class="img_huter"
                            src="../../images/img_tools_500x500/gazon_huter-500x500.png"
                            id="open_pop_up"
                            alt=""
                        >
                        <div class="pop_up" id="pop_up">
                            <div class="pop_up_container">
                                <div class="pop_up_body">
                                    ...
                                    <img src="../../images/img_tools_500x500/gazon_huter-500x500.png">
            ...
            <div class="description_box">
                <div class="options">
                    <ul>
                        <li>Бренд:</li>
                        <li>Тип:</li>
                        <li>Ширина скашивания:</li>
                        <li>Травосборник:</li>
                        <li>Высота скашивания:</li>
                        <li>Число уровней высоты:</li>
                        <li>Двигатель:</li>
                        <li>Мощность:</li>
                    </ul>
                </div>
                <div class="options_descriptions">
                    ...
                    <p>газонокосилка</p>
                    <p>46 см</p>
                    <p>мягкий, объем 60 л</p>
                    <p>25 мм</p>
                    <p>7</p>
                    <p>бензиновый, четырехтактный</p>
                    <p>5 л.с</p>
                </div>
            </div>
            <div class="dastination">
                <p>
                    По показателю производительности и эффективности 
                    бензиновая газонокосилка Huter GLM-5.0 ST обходит 
                    многих своих конкурентов. Эта модель позволяет быстро 
                    и качественно подстричь газон/лужайку перед вашим домом. 
                    И самое главное – полная автономность инструмента, не 
                    требующего обязательную привязку к электрической сети. 
                    При этом управление выполнено максимально практично, 
                    а 4 подвижных, колёсных блока обеспечивают отличное 
                    сцепление с дорогой. Преимуществами этой газонокосилки 
                    на бензиновом двигателе стоит считать: наличие вместительного 
                    сборника травы из мягкой ткани; быстрый запуск; компактные 
                    размеры для хранения и транспортировки за счёт складной 
                    конструкции ручки; реализованная функция заднего выброса травы.
                </p>
            </div>


            <form class="form-buy_button">
                <a href="../../SQL/products_garden.php" class="btn-buy" type="submit">Перейти к товару</a>
            </form>
