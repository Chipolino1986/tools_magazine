    ...
    <section class="section-1">
        ...
        <div class="container">
            <h1>Строительный фен iNGCO HG20082-1</h1>
                <div class="img_box_wrapper">
                    ...
                    <div class="img_box">
                        <img
                            class="img_huter"
                            src="../../images/img_tools_500x500/electro/fen_iNGCO-500x500.png"
                            id="open_pop_up"
                            alt=""
                        >
                        <div class="pop_up" id="pop_up">
                            <div class="pop_up_container">
                                <div class="pop_up_body">
                                    ...
                                    <img src="../../images/img_tools_500x500/electro/fen_iNGCO-500x500.jpg">
            ...
            <div class="description_box">
                <div class="options">
                    <ul>
                        ...
                        <li>Макс.воздушный поток:</li>
                        <li>Регулировка потока воздуха:</li>
                        <li>Питание:</li>
                        <li>Комплектация:</li>
                    </ul>
                </div>
            ...
            <div class="dastination">
                <p>
                    мощность: 2000 Вт, дисплей, регулировка 
                    температуры: плавная, регулировка потока воздуха, 
                    насадки в комплекте, минимальная рабочая температура: 
                    50 °C, максимальная рабочая температура: 600 °C, 
