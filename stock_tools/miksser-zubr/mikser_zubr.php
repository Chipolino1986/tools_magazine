...
<head>
    ...
    <title>Миксер ЗУБР</title>
    <link rel="stylesheet" href="../../NORMALIZE!!!/normalize.css">
    <link rel="stylesheet" href="./mikser_zubr.css">
        ...
        <div class="container">
            <h1>Миксер ЗУБР 1400-2</h1>
                <div class="img_box_wrapper">
                    ...
                    <div class="img_box">
                        <img
                            class="img_huter"
                            src="../../images/img_tools_500x500/electro/mikser_zubr.png"
                            id="open_pop_up"
                            alt=""
                        >
                        <div class="pop_up" id="pop_up">
                            <div class="pop_up_container">
                                <div class="pop_up_body">
                                    ...
                                    <img src="../../images/img_tools_500x500/electro/mikser_zubr.png">
            ...
            <div class="description_box">
                ...
                <div class="options_descriptions">
                    ...
                    <p>1400 Вт</p>
                    <p>810 об/мин</p>
                    <p>блокировка кнопки включения</p>
                </div>
            </div>
            <div class="dastination">
                <p>
                    Простой и надежный миксер для 
                    перемешивания растворов и смесей 
                    любого типа. Широкий диапазон скоростей 
                    перемешивания благодаря двухскоростному редуктору 
                    и электронной регулировке оборотов. Уверенное 
                    оперирование изделием за счет широко разнесенных 
                    рукояток с резиновым покрытием
                </p>
            </div>
