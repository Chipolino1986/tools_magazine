...
<head>
    ...
    <title>Электродрель Metabo</title>
    <link rel="stylesheet" href="../../NORMALIZE!!!/normalize.css">
    <link rel="stylesheet" href="./drel_metabo.css">
...
<body>
    ...
    <section class="section-1">
        ...
        <div class="container">
            <h1>Электродрель Metabo SBEV 1300-2 S</h1>
                <div class="img_box_wrapper">

                    <div class="img_box">
                        <img
                            class="img_huter"
                            src="../../images/img_tools_500x500/electro/drel_metabo.1000x1000.png"
                            id="open_pop_up"
                            alt=""
                        >
                        <div class="pop_up" id="pop_up">
                            <div class="pop_up_container">
                                <div class="pop_up_body">
                                    ...
                                    <img src="../../images/img_tools_500x500/electro/drel_metabo.1000x1000.jpg">
            ...
            <div class="description_box">
                <div class="options">
                    <ul>
                        ...
                        <li>Тип:</li>
                        <li>Тип патрона:</li>
                        <li>Количество скоростей:</li>
                        <li>Диаметр патрона:</li>
                        <li>Макс.кол-во ударов:</li>
                ...
                <div class="options_descriptions">
                    ...
                    <p>От сети</p>
                    <p>
                        дополнительная рукоятка, ограничитель 
                        глубины сверления, кейс
                    </p>
                </div>
            </div>
            <div class="dastination">
                <p>
                    тип: дрель, тип питания: от сети, наличие 
                    удара (для дрели): ударная, тип патрона: 
                    быстрозажимной, функции: защита от перегрузок, 
                    работа в стойке сверлильного станка, реверс, 
                    регулировка частоты вращения, потребляемая мощность: 
                    1300 Вт, максимальный крутящий момент: 44 Н·м, 
                    особенности конструкции: блокировка кнопки включения, 
                    дополнительная рукоятка, использование бит без патрона, 
                    ограничитель глубины сверления, предохранительная муфта, 
                    фиксация шпинделя, количество скоростей работы: 2, 
                    упаковка: кейс, вес: 2.80 кг 
                </p>
            </div>
