...
<head>
    ...
    <title>Клеевый пистолет Tundra</title>
    <link rel="stylesheet" href="../../NORMALIZE!!!/normalize.css">
    <link rel="stylesheet" href="./kley-pistol.css">
...
<body>
    ...
    <section class="section-1">
        ...
        <div class="container">
            <h1>Клеевый пистолет Tundra</h1>
                <div class="img_box_wrapper">

                    <div class="img_box">
                        <img
                            class="img_huter"
                            src="../../images/img_tools_500x500/electro/kley-pistol-700x700.png"
                            id="open_pop_up"
                            alt=""
                        >
                        <div class="pop_up" id="pop_up">
                            <div class="pop_up_container">
                                <div class="pop_up_body">
                                    ...
                                    <img src="../../images/img_tools_500x500/electro/kley-pistol-700x700.jpg">
            ...
            <div class="dastination">
                <p>
                    Клеевой пистолет марки TUNDRA предназначен 
                    для склеивания различных материалов горячим 
                    клеем. Инструмент имеет широкую сферу применения. 
                    Встроенная откидная подставка позволит принять 
                    инструменту устойчивое положение во время перерывов. 
                    Рукоятка пистолета удобно ложится в руку, обеспечивая 
                    надёжный захват. Важно! В рабочем состоянии пистолет 
                    должен находиться только в вертикальном положении. 
                    Преимущества: Компактный размер для качественных работ 
                    и склеивания труднодоступных мест; Пистолет быстро 
                    нагревается и сохраняет рабочую температуру; Широкий 
                    курок механизма подачи обеспечит полный контроль во 
                    время работы; Подставка для фиксации инструмента во 
                    время перерывов.
                </p>
            </div>
