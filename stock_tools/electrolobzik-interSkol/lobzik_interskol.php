...
<head>
    ...
    <title>Электролобзик Интерскол</title>
    <link rel="stylesheet" href="../../NORMALIZE!!!/normalize.css">
    <link rel="stylesheet" href="./lobzik_interskol.css">
...
<body>
    ...
    <section class="section-1">
        ...
        <div class="container">
            <h1>Электролобзик Интерскол МП-100/700Э</h1>
                <div class="img_box_wrapper">

                    <div class="img_box">
                        <img
                            class="img_huter"
                            src="../../images/img_tools_500x500/electro/lobzik-interskol-800x800.png"
                            id="open_pop_up"
                            alt=""
                        >
                        <div class="pop_up" id="pop_up">
                            <div class="pop_up_container">
                                <div class="pop_up_body">
                                    ...
                                    <img src="../../images/img_tools_500x500/electro/lobzik-interskol-800x800.jpg">
            ...
            <div class="description_box">
                ...
                <div class="options_descriptions">
                    ...
                    <p>3 кг</p>
                    <p>От сети</p>
                    <p>700-3000 ход/мин</p>
                    <p>
                        Лобзик,руководство по эксплуатации,инструкция по безопасности,
                        гарантийный талон,направляющая линейка,винт фиксации направляющей линейки,
                        центр циркульный,ключ торцовый шестигранный S3.
                    </p>
                </div>
            </div>
            <div class="dastination">
                <p>
                    Лобзик Интерскол МП-100/700Э 15.1.1.11 
                    предназначен для резки пиломатериалов, строительных 
                    и мебельных плит на основе древесины (ДСП, ЦСП и т.п.), 
                    листа и фасонного профиля из стали, цветного металла, 
                    пластмассы и других материалов (кроме асбестосодержащих). 
                    Инструмент оснащен защитным экраном - для комфортной 
                    и безопасной работы.
                </p>
            </div>
