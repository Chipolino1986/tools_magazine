...
<head>
    ...
    <title>Перфоратор Makita</title>
    <link rel="stylesheet" href="../../NORMALIZE!!!/normalize.css">
    <link rel="stylesheet" href="./perforator_makita.css">
...
<body>
    ...
    <div class="header">
        ...
        <div class="container">
            <h1>Перфоратор Makita DHR242RFE</h1>
                <div class="img_box_wrapper">

                    <div class="img_box">
                        <img
                            class="img_huter"
                            src="../../images/img_tools_500x500/acum/perforator_makita-800x800.png"
                            id="open_pop_up"
                            alt=""
                        >
                        <div class="pop_up" id="pop_up">
                            <div class="pop_up_container">
                                <div class="pop_up_body">
                                    ...
                                    <img src="../../images/img_tools_500x500/acum/perforator_makita-800x800.jpg">
            ...
            <div class="description_box">
                <div class="options">
                    <ul>
                        ...
                        <li>Тип:</li>
                        <li>Сила удара:</li>
                        <li>Макс.частота ударов:</li>
                        <li>Напряжение аккумулятора:</li>
                        <li>Макс.диаметр сверления:</li>
                        <li>Вес:</li>
                        <li>Питание:</li>
                ...
                <div class="options_descriptions">
                    ...
                    <p>4700 уд/мин</p>
                    <p>18 В</p>
                    <p>24 мм (бетон), 13 мм (метал)</p>
                    <p>3.3 кг</p>
                    <p>От аккумулятора</p>
                    <p>
                        перфоратор, боковая рукоятка, ограничитель глубины сверления, 
                        два аккумулятора, зарядное устройство, кейс
                    </p>
                </div>
            </div>
            <div class="dastination">
                <p>
                    Перфоратор аккумуляторный MAKITA DHR242RFE 
                    оснащен надежным бесщёточным мотором, который 
                    прослужит долго. Инструмент предназначен для сверления 
                    отверстий и ведения локальных отбойных работ. 
                    Идеально подобранный центр тяжести, расположенный 
                    вблизи рукоятки, способствует комфортной работе. 
                    Наличие предохранительной муфты исключает риск 
                    проворачивания инструмента в руках оператора при 
                    клине оснастки. Обрезиненная боковая рукоятка 
                    обеспечивает надежный хват. Модель поставляется в 
                    чемодане, в котором её удобно хранить и транспортировать. 
                </p>
            </div>
