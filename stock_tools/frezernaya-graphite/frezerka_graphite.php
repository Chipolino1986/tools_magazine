...
<head>
    ...
    <title>Фрезер Graphite</title>
    <link rel="stylesheet" href="../../NORMALIZE!!!/normalize.css">
    <link rel="stylesheet" href="./frezerka_graphite.css">
    ...
    <div class="header">
        ...
        <div class="container">
            <h1>Фрезер Graphite 59G717</h1>
                <div class="img_box_wrapper">
                    ...
                    <div class="img_box">
                        <img
                            class="img_huter"
                            src="../../images/img_tools_500x500/electro/frezer_graphite-550x550.png"
                            id="open_pop_up"
                            alt=""
                        >
                        <div class="pop_up" id="pop_up">
                            <div class="pop_up_container">
                                <div class="pop_up_body">
                                    ...
                                    <img src="../../images/img_tools_500x500/electro/frezer_graphite-550x550.jpg">
            ...
            <div class="description_box">
                <div class="options">
                    <ul>
                        ...
                        <li>глубина фрезерования:</li>
                        <li>Скорость вращения:</li>
                        <li>Размер цанг в комплекте:</li>
                ...
                <div class="options_descriptions">
                    ...
                    <p>1300 Вт</p>
                    <p>55 мм</p>
                    <p>11000-28000 об/мин</p>
                    <p>6 мм, 8 мм, 12 мм</p>
                    <p>есть</p>
                    <p>есть</p>
                    <p> 
                        параллельный упор, копировальная втулка, 
                        адаптер для пылесоса, зажимная цанга 3 шт, 
            ...
            <div class="dastination">
                <p>
                    Фрезерный станок GRAPHITE с мощным двигателем 1300 Вт, предназначен для фрезерования отверстий, пазов, кромок и профилей во всех видах древесины и древесных материалов, а также в пластике и алюминии.
                    Устройство имеет функцию плавного контроля скорости и глубины фрезерования.
                    Фрезерный станок имеет блокировку шпинделя и блокировку глубины фрезерования. Глубину фрезерования можно регулировать с помощью трех инструментов: 8-ступенчатого ограничителя глубины, ограничителя глубины с плавной регулировкой (диапазон 0–55 мм) и ручки точной регулировки глубины (точность 0,1 мм).
                    Устройство оснащено устойчивой алюминиевой ножкой с пластиковым колпачком, обеспечивающим легкое ведение устройства на всех типах поверхностей.
                    Направляющие фрезерного двигателя встроены в алюминиевый корпус с гнездами, подвергнутыми специальной обработке поверхности, благодаря чему устройство отличается повышенной точностью при врезании.
                </p>
            </div>


            <form class="form-buy_button">
                <a href="../../SQL/products_test_2.php" class="btn-buy" type="submit">Перейти к товару</a>
            </form>
