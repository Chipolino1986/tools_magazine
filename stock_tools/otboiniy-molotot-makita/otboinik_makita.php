...
<head>
    ...
    <title>Отбойный молот Makita</title>
    <link rel="stylesheet" href="../../NORMALIZE!!!/normalize.css">
    <link rel="stylesheet" href="./otboinik_makita.css">
...
<body>
    ...
    <div class="header">
        ...
        <div class="container">
            <h1>Отбойный молот Makita HM1307C</h1>
                <div class="img_box_wrapper">

                    <div class="img_box">
                        <img
                            class="img_huter"
                            src="../../images/img_tools_500x500/electro/otbojnyj-molotok-makita-.800x800.png"
                            id="open_pop_up"
                            alt=""
                        >
                        <div class="pop_up" id="pop_up">
                            <div class="pop_up_container">
                                <div class="pop_up_body">
                                    ...
                                    <img src="../../images/img_tools_500x500/electro/otbojnyj-molotok-makita-.800x800.jpg">
            ...
            <div class="description_box">
                ...
                <div class="options_descriptions">
                    ...
                    <p>1.5 кВт</p>
                    <p>2 л.с.</p>
                    <p>шестигранник (HEX)</p>
                    <p>
                        антивибрационная система, 
                        блокировка кнопки включения, 
                        индикатор износа угольных щеток, 
                        регулировка положения оснастки, 
            ...
            <div class="dastination">
                <p>
                    тип: электрический, тип патрона: шестигранник (HEX), 
                    макс. энергия удара: 18.60 Дж, мощность: 1.50 кВт, 
                    функции: плавный пуск, регулировка частоты ударов, 
                    особенности конструкции: антивибрационная система, 
                    блокировка кнопки включения, индикатор износа угольных 
                    щеток, регулировка положения оснастки, система снижения 
                    шума, макс. частота ударов: 1900 уд/мин, дополнительно 
                    в комплекте: дополнительная рукоятка, зубило/пика, упаковка: 
                    кейс, вес: 15.30 кг
                </p>
            </div>
