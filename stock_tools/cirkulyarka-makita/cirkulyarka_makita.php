...
<head>
    ...
    <title>Циркулярная пила Makita</title>
    <link rel="stylesheet" href="../../NORMALIZE!!!/normalize.css">
    <link rel="stylesheet" href="./cirkulyarka_makita.css">
...
<body>
    ...
    <section class="section-1">
        ...
        <div class="container">
            <h1>Циркулярная пила Makita</h1>
                <div class="img_box_wrapper">

                    <div class="img_box">
                        <img
                            class="img_huter"
                            src="../../images/img_tools_500x500/acum/cirkulyarka_makita-600x600.png"
                            id="open_pop_up"
                            alt=""
                        >
                        <div class="pop_up" id="pop_up">
                            <div class="pop_up_container">
                                <div class="pop_up_body">
                                    ...
                                    <img src="../../images/img_tools_500x500/acum/cirkulyarka_makita-600x600.jpg">
            ...
            <div class="description_box">
                ...
                <div class="options_descriptions">
                    ...
                    <p>3.3 кг</p>
                    <p>От аккумулятора</p>
                    <p>пильный диск, ключ (без аккумулятора и зарядного устройства)</p>
                </div>
            </div>
            <div class="dastination">
                <p>
                    Аккумуляторная дисковая пила Makita DHS680Z 
                    очень удобна в эксплуатации. Светодиодный 
                    фонарь для освещения рабочей зоны и встроенный 
                    адаптер для пылесоса дают возможность хорошо видеть 
                    линию разметки. Система торможения двигателя и 
                    нескользящая направляющая ручка обеспечивают высокий 
                    уровень безопасности во время эксплуатации. 
                </p>
            </div>
