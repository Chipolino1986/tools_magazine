...
<head>
    ...
    <title>Кусторез BOSCH</title>
    <link rel="stylesheet" href="../../NORMALIZE!!!/normalize.css">
    <link rel="stylesheet" href="./kustorez_bosch.css">
...
<body>
    ...
    <div class="header">
        ...
        <div class="container">
            <h1>Кусторез BOSCH</h1>
                <div class="img_box_wrapper">

                    <div class="img_box">
                        <img
                            class="img_huter"
                            src="../../images/img_tools_500x500/electro/Kustorez_bosch-800x800.png"
                            id="open_pop_up"
                            alt=""
                        >
                        <div class="pop_up" id="pop_up">
                            <div class="pop_up_container">
                                <div class="pop_up_body">
                                    ...
                                    <img src="../../images/img_tools_500x500/electro/Kustorez_bosch-800x800.jpg">
            ...
            <div class="dastination">
                <p>
                    Кусторез электрический Bosch UniversalHedgeGut 60
                </p>
            </div>
